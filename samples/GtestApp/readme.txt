GtestApp is a sample project demonstrating usage of an externally-supplied source code module that does not supply a globifest manifest.  This builds a test application using GoogleTest.
